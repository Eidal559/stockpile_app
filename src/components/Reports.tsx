    ...
    <div className="space-y-8">
      ...
      {reportType === 'value' && (
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="space-y-4">
            {reportData.categoryBreakdown.map((category) => {
              const percentage = (category.value / reportData.totalValue) * 100;
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="flex space-x-4">
          <button className="flex items-center space-x-2 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg transition duration-200">
            <Calendar size={16} />
            <span>Export Current Report</span>
          </button>
          <button className="flex items-center space-x-2 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition duration-200">
            <BarChart3 size={16} />
